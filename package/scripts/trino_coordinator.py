...
class Coordinator(Script):
    ...
    def start(self, env):
        ...
        coordinator_hosts = 'trino_query2_coordinator_hosts'
        worker_hosts = 'trino_query2_worker_hosts'
        ...
        smoketest_trino(TrinoClient('localhost', 'root', config_properties['http-server.http.port']), all_hosts)
